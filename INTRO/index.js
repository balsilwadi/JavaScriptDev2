//console
console.log("This prints out a message in the console")
console.warn("WARNING")//This gives a yellow warning in the console
console.error("ERROR")//This gives a red error in the console

//document
document.write("This is an message from index.js")//provides text in the dom
alert("this is an alert")//provides a javascript alert popup
